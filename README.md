...
##### 비교해 보고 뭐가 잘 못 된지 알아야 공부가 됩니다^^ 나스서버 숙제폴더에 구동 된 거 올려주세요!(4월29일 월요일까지~) 
##### 혹시 구동이 안된다!! 숙제 폴더에 올리시고, 메모장에다가 구동이 안된다고 적어서 같이 올려주세요!! (메모장이 없는 학생은 잘 구동 된다고 알고 있을게요^^) 좋은 주말 보내영^^
### html코드
```html
<!DOCTYPE html>
<html lang="ko">
